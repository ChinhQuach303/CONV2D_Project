...
#ifndef __doConv_mac_muladdeOg__HH__
#define __doConv_mac_muladdeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doConv_mac_muladdeOg) {
    ...
    SC_CTOR(doConv_mac_muladdeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
