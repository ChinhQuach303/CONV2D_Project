...
#ifndef __doConv_mac_muladdfYi__HH__
#define __doConv_mac_muladdfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doConv_mac_muladdfYi) {
    ...
    SC_CTOR(doConv_mac_muladdfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
